...
{
    public partial class Exercise02 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true, collation: "utf8mb4_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    qoh = table.Column<int>(type: "int(11)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderInventory_InventoryProduct",
                        column: x => x.inventoryid,
                        principalTable: "inventoryproduct",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_OrderInventory_OrderInvoice",
                        column: x => x.orderid,
                        principalTable: "orderinvoice",
                        principalColumn: "id");
                })
                .Annotation("MySql:CharSet", "utf8mb4")
                .Annotation("Relational:Collation", "utf8mb4_general_ci");
